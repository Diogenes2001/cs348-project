...
<div class="bg">
  <myHeader />
    ...
    <b-card style="width: 400px;" header="Sign up" border-variant="dark" header-class="h1 text-center" header-bg-variant="white">
        <div>
            <b-form @submit="onSubmit" @reset="onReset">
                ...
                <b-button href="/login" variant="secondary" style="margin-left: 10px; width: 48%;">Login</b-button>
                </b-form>
        </div>
    </b-card>
    </b-row>
  ...
  export default {
    ...
    methods: {
      onSubmit(event) {
        ...
        var path = 'http://127.0.0.1:5000/signup';
        console.log(params);
